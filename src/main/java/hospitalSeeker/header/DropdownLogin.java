...
public class DropdownLogin {
	@FindBy(xpath = "/html/body/hospitalSeeker.header/div/div/div[2]/nav/div/div[2]/ul/li[7]/a")
	...
	@FindBy(xpath = "/html/body/hospitalSeeker.header/div/div/div[2]/nav/div/div[2]/ul/li[7]/ul/div/form/div[3]/div/div[1]/input")
	public WebElement dropdownRememberMeCheckbox;

	@FindBy(xpath = "/html/body/hospitalSeeker.header/div/div/div[2]/nav/div/div[2]/ul/li[7]/ul/div/form/div[3]/div/div[2]/input")
	public WebElement dropdownLoginSubmitButton;

	@FindBy(xpath = "/html/body/hospitalSeeker.header/div/div/div[2]/nav/div/div[2]/ul/li[6]/a")
